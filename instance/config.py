...
OUR_HOST=os.getenv("DB_HOST", "192.168.10.17")
...
CELERY_BROKER_URL = os.getenv("CELERY_BROKER_URL", "redis://192.168.10.17:6379/0")              
CELERY_RESULT_BACKEND = os.getenv("CELERY_RESULT_BACKEND", "redis://192.168.10.17:6379/0")
